              ...
              <div class="container-fluid">
                <div class="navbar-header">
                  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
                    ...
                    <a href="index.php"><img src="estilos/img/logo-descargar.png" class="logo" alt="Logo BuffetS"></a>
                </div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li class="margen-li-nav">
                            <a href="index.php" style="color: #fff;" class="primer-p-nav p-nav">
                              <span class="glyphicon glyphicon-home" style="margin-right: 5px;"></span>Inicio
                            </a>
                        </li>
                        <li>
                            <a href="<?=$_SESSION['url_menu'];?>" style="color: #fff;" class="p-nav"><span class="glyphicon glyphicon-cutlery" style="margin-right: 5px;"></span>Menú
                            </a>
                        </li>
                        <li>
                            <a href="informacion.php" style="color: #fff;" class="p-nav"><span class="glyphicon glyphicon-info-sign" style="margin-right: 5px;"></span>Información
                            </a>
                        </li>
                        <li>
                          <a href="canasta.php" style="color: #fff;" class="p-nav"><span class="glyphicon glyphicon-shopping-cart" style="margin-right: 5px;"></span>Carrito</a>
                        </li>
                        <li>
                          <?=$_SESSION['admin_header']; ?>
                        </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                      <li>
                          <a href="<?=$_SESSION['logout'];?>" style="color: #fff;" class="p-nav"><span class="<?=$_SESSION['logout_icono'];?>" style="margin-right: 5px;"></span><?=$_SESSION['logout_texto'];?>
                          </a>
                      </li>
                      <li>
